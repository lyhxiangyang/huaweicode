...
trainAbnormalDataPath = [
    "tmp/tData-10-18/多机-E5-process-server-3KM/9.特征提取所有错误-处理首尾/61.csv",
    "tmp/tData-10-18/多机-E5-process-server-3KM/9.特征提取所有错误-处理首尾/62.csv",
    "tmp/tData-10-18/多机-E5-process-server-3KM/9.特征提取所有错误-处理首尾/63.csv",
    "tmp/tData-10-18/多机-E5-process-server-3KM/9.特征提取所有错误-处理首尾/64.csv",
    "tmp/tData-10-18/多机-E5-process-server-3KM/9.特征提取所有错误-处理首尾/65.csv",
]
...
testAbnormalDataPath = [
    "tmp/tData-10-18/多机-红区-process-server-3KM/7.特征提取所有错误-未处理首尾/61.csv",
    "tmp/tData-10-18/多机-红区-process-server-3KM/7.特征提取所有错误-未处理首尾/62.csv",
    "tmp/tData-10-18/多机-红区-process-server-3KM/7.特征提取所有错误-未处理首尾/63.csv",
    "tmp/tData-10-18/多机-红区-process-server-3KM/7.特征提取所有错误-未处理首尾/64.csv",
    "tmp/tData-10-18/多机-红区-process-server-3KM/7.特征提取所有错误-未处理首尾/65.csv",
]
...
if __name__ == "__main__":
    ...
    # 都选
    # allfeatureload1_nosuffix = get_List_pre_suffix(list(allTrainedPD.columns.array),prefix="used_", suffix="")
