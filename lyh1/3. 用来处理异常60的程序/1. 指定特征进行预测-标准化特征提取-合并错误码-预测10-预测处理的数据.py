...
testAbnormalDataPath = [
    "tmp/tData-10-18/多机-红区-process-server-3KM/9.特征提取所有错误-处理首尾/61.csv",
    "tmp/tData-10-18/多机-红区-process-server-3KM/9.特征提取所有错误-处理首尾/62.csv",
    "tmp/tData-10-18/多机-红区-process-server-3KM/9.特征提取所有错误-处理首尾/63.csv",
    "tmp/tData-10-18/多机-红区-process-server-3KM/9.特征提取所有错误-处理首尾/64.csv",
    "tmp/tData-10-18/多机-红区-process-server-3KM/9.特征提取所有错误-处理首尾/65.csv",
]
