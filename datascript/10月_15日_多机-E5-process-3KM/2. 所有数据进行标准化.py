...
if __name__ == "__main__":
    normalpath = "tmp/tData-10-18/多机-E5-process-server-3KM/1.所有process错误码信息/0.csv"
    file_time_corePath = "tmp/tData-10-18/多机-E5-process-server-3KM/2.filename-time-core"
    file_time_core_faultyPath: str = "tmp/tData-10-18/多机-E5-process-server-3KM/3.filename-time-core-faulty"
