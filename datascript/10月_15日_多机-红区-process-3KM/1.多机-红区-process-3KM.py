...
datapathsever = "D:/HuaweiMachine/数据分类/wrf/多机/红区/3KM/异常数据/wrf_3km_160_server.csv"
datapath = [
...
if __name__ == "__main__":
    ...
    for ipath in datapath:
        ...
        # tmp/{filename}
        onefile_Faulty_PD_Dict, time_core_pdDict, time_core_faultDict = processOneFile(
            spath=os.path.join(spath, "0.所有文件处理过程", filename), filepd=server_process_pd,
            isSlide=isSlideWin)
