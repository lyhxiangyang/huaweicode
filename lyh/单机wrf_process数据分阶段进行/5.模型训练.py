...
savepath4 = "tmp\\wrf_single_process\\4\\"
filename4 = "alluserful.csv"
savepath5 = "tmp\\wrf_single_process\\5\\"
...
if __name__ == "__main__":
    ...
    print(itpd)
    itpd.to_csv(os.path.join(saverespath, "单机5_预测数据统计信息.csv"))
    print("=========================")
    print("输出信息->", os.path.join(saverespath, "单机5_预测数据统计信息.csv"))
    print("模型预测结束")
